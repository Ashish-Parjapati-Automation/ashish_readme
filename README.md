...
### Senior RPA Developer · Automation Architect · Agentic AI Engineer

> **UiPath Certified Advanced RPA Developer (UiARD)** · 6.7 years · Delhi NCR · Open to remote
...
- 🔗 **Integrations** — REST APIs, SOAP/WSDL, ServiceNow, SSRS, Azure DevOps
- 🧠 **Agentic AI** — Building LLM-powered automation agents using Groq SDK (LLaMA) + TypeScript
...
| | |
|---|---|
| **90% manual effort reduction** | IDP pipeline — 5,600+ documents automated end-to-end |
...
- Polls Orchestrator API → evaluates job state → sends contextual email alert → kills stuck jobs via API
- Kill thresholds based on real production failure patterns (Terminating >5 min, Queue jobs >10 min, etc.)
- LLM (LLaMA via Groq) generates natural language alerts and handles ambiguous job states
...
*"Automation isn't about replacing people — it's about letting them do work that actually matters."*
